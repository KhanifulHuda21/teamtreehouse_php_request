...
<html lang="en">
  ...
  <div class="container">
    ...
    <form class="border rounded p-4 " method="GET" action="index.php">
		...
		<input  class="mt-2 btn btn-primary" type="submit" name="action" value="Daftar" >
	</form>
    ...
    <div class="col-4">
    <h3 class="mt3">Tambah Tim</h3>
    <form class="border rounded p-4" method="POST" action="index.php" >
        <input class="form-control" type="text" name="nama" placeholder="nama tim"><br>
		<input  class="mt-2 btn btn-primary" type="submit" name="action" value="Tambah">
	</form>
    </div>
